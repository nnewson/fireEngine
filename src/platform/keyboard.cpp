...
constexpr std::array<int, static_cast<std::size_t>(Key::Count)> kGlfwKeyCodes{
    ...
    GLFW_KEY_D,           GLFW_KEY_E,    GLFW_KEY_F,     GLFW_KEY_V,
    GLFW_KEY_1,           GLFW_KEY_2,    GLFW_KEY_3,     GLFW_KEY_LEFT_SHIFT,
    GLFW_KEY_RIGHT_SHIFT, GLFW_KEY_LEFT, GLFW_KEY_RIGHT, GLFW_KEY_F1,
};
