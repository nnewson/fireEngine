      ...
      pointShadowPass_(RenderPass::createShadow(device))
{
    ...
    spotShadowPass_.createShadowFramebuffer(
        *device_, resources_->vulkanImageView(spotShadowColourHandle_), spotDepthViews,
        spotShadowMapExtent);
    ...
    pointShadowPass_.createShadowFramebuffer(
        *device_, resources_->vulkanImageView(pointShadowColourHandle_), pointFaceViews,
