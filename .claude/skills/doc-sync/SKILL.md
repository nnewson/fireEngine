...
`README.md`, `roadmap.md`, `CLAUDE.md` / `AGENTS.md` stay at the repo root. Cross-references are
relative links: a `docs/` file → a sibling is bare (`collision.md`), → a root file is `../roadmap.md`;
a root file → a `docs/` file is `docs/collision.md`.

## By change type

| Change | Update |
|---|---|
| Rendering feature | `README.md` + `docs/onboarding.md` + `docs/review-order.md` + `roadmap.md` |
...
| Roadmap item landed | `roadmap.md` status |
